  ...
  export class Promise<T = any, TProgress = any> {
    constructor(
      executor: (
        ...
        progress: (progress: TProgress) => void
      ) => void,
      oncancel?: () => void
    )
    ...
    ): Promise<TResult1 | TResult2, TProgress>
    ...
    public static as<T, TPromise extends PromiseLike<T>>(
      value: TPromise
    ): TPromise
...
declare namespace monaco.languages {
  ...
  export interface CompletionItemProvider {
    ...
    provideCompletionItems(
      document: editor.IReadOnlyModel,
      position: Position,
      token: CancellationToken,
  ...
  export interface DocumentColorProvider {
    ...
    provideDocumentColors(
      model: editor.IReadOnlyModel,
      token: CancellationToken
    ): IColorInformation[] | Thenable<IColorInformation[]>
    /**
    ...
    provideColorPresentations(
      ...
      token: CancellationToken
    ): IColorPresentation[] | Thenable<IColorPresentation[]>
  }
