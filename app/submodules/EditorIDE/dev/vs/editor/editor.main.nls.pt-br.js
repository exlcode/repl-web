...
define("vs/editor/editor.main.nls.pt-br", {
	...
	"vs/editor/common/config/commonEditorConfig": [
		...
		"Renderiza réguas verticais após um certo número de caracteres de espaço. Use vários valores para várias réguas. Réguas não serão desenhadas se a matriz estiver vazia",
		...
		"Controla se o controle deslizante minimap é automaticamente escondido. Os valores possíveis são \'sempre\' e \'mouseover\'",
		...
		"Habilita a ação de código lightbulb",
	...
	"vs/editor/common/view/editorColorRegistry": [
		...
		"Cor do primeiro plano das linhas de informação no editor.",
		"Cor da borda das linhas de informação no editor.",
		"Visão geral da cor do marcador da régua para intervalos de destaques.",
	...
	"vs/editor/contrib/gotoError/browser/gotoError": [
		...
		"Cor de informação da ferramenta de navegação do marcador do editor.",
	...
	"vs/editor/contrib/wordHighlighter/common/wordHighlighter": [
		...
		"Visão geral da cor do marcador da régua para destaques de símbolos.",
		"Visão geral da cor do marcador da régua para gravação de destaques de símbolos.",
	],
	...
	"vs/platform/theme/common/colorRegistry": [
		...
		"Visão geral da cor do marcador da régua para buscas correspondentes.",
		"Visão geral da cor do marcador da régua para a seleção de destaques",
	],
