...
define("vs/editor/editor.main.nls.ja", {
	...
	"vs/editor/common/config/commonEditorConfig": [
		...
		"ミニマップのスライダーを自動的に非表示にするかどうかを制御します。指定できる値は \'always\' と \'mouseover\' です",
	...
	"vs/editor/contrib/wordHighlighter/common/wordHighlighter": [
		...
		"シンボルを強調表示するときの概要ルーラーのマーカー色。",
		"書き込みアクセス シンボルを強調表示するときの概要ルーラーのマーカー色。",
	],
