...
define("vs/editor/editor.main.nls.tr", {
	...
	"vs/editor/common/config/commonEditorConfig": [
		...
		"Belirli bir eşit genişlikli karakterlerden sonra dikey cetveller göster. Birden çok cetvel için birden çok değer kullanın. Dizi boş ise cetvel gösterilmez",
		...
		"Düzenleyicinin bir animasyon kullanarak kaydırıp kaydırmayacağını denetler",
		"Mini haritanın gösterilip gösterilmeyeceğini denetler",
		"Mini harita kaydıracının otomatik olarak gizlenip gizlenmeyeceğini denetler. Alabileceği değerler \'always\' ve \'mouseover\'dır.",
		...
		"Düzenleyicinin satır içi renk dekoratörlerini ve renk seçiciyi gösterip göstermemesini denetler.",
		"Kod eylemleri ampulunu etkinleştirir",
	...
	"vs/editor/common/view/editorColorRegistry": [
		...
		"Düzenleyicideki bilgilendirme karalamalarının ön plan rengi.",
		"Düzenleyicideki bilgilendirme karalamalarının kenarlık rengi.",
		"Aralık vurguları için genel bakış cetvelinin işaretleyici rengi.",
		"Hatalar için genel bakış cetvelinin işaretleyici rengi.",
		"Uyarılar için genel bakış cetvelinin işaretleyici rengi.",
		"Bilgilendirmeler için genel bakış cetvelinin işaretleyici rengi.",
	],
	...
	"vs/editor/contrib/gotoError/browser/gotoError": [
		...
		"Düzenleyicinin işaretçi gezinti aracının bilgilendirme rengi.",
	...
	"vs/editor/contrib/wordHighlighter/common/wordHighlighter": [
		...
		"Sembol vurguları için genel bakış cetvelinin işaretleyici rengi.",
		"Yazma erişimli sembol vurguları için genel bakış cetvelinin işaretleyici rengi.",
	],
	...
	"vs/platform/theme/common/colorRegistry": [
		...
		"Bulunan eşler için genel bakış cetvelinin işaretleyici rengi.",
		"Seçim vurguları için genel bakış cetvelinin işaretleyici rengi.",
	],
