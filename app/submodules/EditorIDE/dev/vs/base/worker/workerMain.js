...
(function() {
var __m = ["exports","require","vs/base/common/winjs.base","vs/editor/common/core/position","vs/base/common/platform","vs/editor/common/core/range","vs/base/common/uri","vs/base/common/event","vs/base/common/errors","vs/base/common/lifecycle","vs/editor/common/core/uint","vs/base/common/cancellation","vs/base/common/functional","vs/base/common/diff/diff","vs/editor/common/model/mirrorModel","vs/base/common/keyCodes","vs/base/common/callbackList","vs/base/common/types","vs/base/common/diff/diffChange","vs/base/common/async","vs/editor/common/viewModel/prefixSumComputer","vs/base/common/map","vs/base/common/strings","vs/editor/common/core/selection","vs/editor/common/core/token","vs/base/common/linkedList","vs/editor/common/core/characterClassifier","vs/editor/common/diff/diffComputer","vs/editor/common/model/wordHelper","vs/editor/common/modes/linkComputer","vs/editor/common/modes/supports/inplaceReplaceSupport","vs/editor/common/standalone/standaloneBase","vs/base/common/worker/simpleWorker","vs/base/common/winjs.base.raw","vs/editor/common/services/editorSimpleWorker"];
...
define(__m[18/*vs/base/common/diff/diffChange*/], __M([1/*require*/,0/*exports*/]), function (require, exports) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
...
define(__m[13/*vs/base/common/diff/diff*/], __M([1/*require*/,0/*exports*/,18/*vs/base/common/diff/diffChange*/]), function (require, exports, diffChange_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[9/*vs/base/common/lifecycle*/], __M([1/*require*/,0/*exports*/,12/*vs/base/common/functional*/]), function (require, exports, functional_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[25/*vs/base/common/linkedList*/], __M([1/*require*/,0/*exports*/]), function (require, exports) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[6/*vs/base/common/uri*/], __M([1/*require*/,0/*exports*/,4/*vs/base/common/platform*/]), function (require, exports, platform) {
    ...
    var URI = /** @class */ (function () {
        ...
        URI.revive = function (data) {
            var result = new _URI(data.scheme, data.authority, data.path, data.query, data.fragment);
...
define(__m[21/*vs/base/common/map*/], __M([1/*require*/,0/*exports*/,6/*vs/base/common/uri*/]), function (require, exports, uri_1) {
    ...
    var StringSegments = /** @class */ (function () {
        function StringSegments() {
        }
        StringSegments.prototype.reset = function (key) {
            this._value = key;
            this._pos = 0;
            return this;
        };
        StringSegments.prototype.join = function (segments) {
            return segments.join('');
        };
        StringSegments.prototype.hasNext = function () {
            return this._pos < this._value.length;
        };
        StringSegments.prototype.next = function () {
            return this._value[this._pos++];
        };
        return StringSegments;
    }());
    exports.StringSegments = StringSegments;
    var PathSegments = /** @class */ (function () {
        function PathSegments() {
        }
        PathSegments.prototype.reset = function (key) {
            this._value = key;
            this._pos = 0;
            return this;
        };
        PathSegments.prototype.join = function (segments) {
            return segments.join('/');
        };
        PathSegments.prototype.hasNext = function () {
            return this._pos < this._value.length;
        };
        PathSegments.prototype.next = function () {
            ...
            if (pos > this._pos) {
                // did advance
                var ret = this._value.substring(this._pos, pos);
                this._pos = pos + 1;
                return ret;
            }
            else {
        ...
        PathSegments._fwd = '/'.charCodeAt(0);
        PathSegments._bwd = '\\'.charCodeAt(0);
        return PathSegments;
    }());
    ...
    var TernarySearchTree = /** @class */ (function () {
        ...
        TernarySearchTree.forPaths = function () {
            return new TernarySearchTree(new PathSegments());
        };
        TernarySearchTree.forStrings = function () {
            return new TernarySearchTree(new StringSegments());
        };
        TernarySearchTree.prototype.set = function (key, element) {
            var segements = this._segments.reset(key);
            this._root = this._set(this._root, segements.next(), segements, element);
        };
        TernarySearchTree.prototype._set = function (node, key, segments, element) {
            if (!node) {
                node = new TernarySearchTreeNode();
                node.str = key;
            }
            if (node.str > key) {
                // left
        ...
        TernarySearchTree.prototype._get = function (node, key, segments) {
            if (!node) {
                return undefined;
            }
            else if (node.str > key) {
        ...
        TernarySearchTree.prototype.delete = function (key) {
            var segments = this._segments.reset(key);
            this._delete(this._root, segments.next(), segments);
        };
        TernarySearchTree.prototype._delete = function (node, key, segments) {
            if (!node) {
                return undefined;
            }
            else if (node.str > key) {
        ...
        TernarySearchTree.prototype._findSubstr = function (node, key, segments, candidate) {
            if (!node) {
                return candidate;
            }
            else if (node.str > key) {
        ...
        TernarySearchTree.prototype._findSuperstr = function (node, key, segments, bucket) {
            if (!node) {
                return;
            }
            else if (node.str > key) {
                ...
                this._forEach(node.mid, [], function (entry) { return bucket.push(entry[1]); });
            }
        };
...
define(__m[22/*vs/base/common/strings*/], __M([1/*require*/,0/*exports*/,21/*vs/base/common/map*/]), function (require, exports, map_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
    ...
    var nfcCache = new map_1.BoundedMap(10000); // bounded to 10000 elements
    function normalizeNFC(str) {
        return normalize(str, 'NFC', nfcCache);
    }
    exports.normalizeNFC = normalizeNFC;
    var nfdCache = new map_1.BoundedMap(10000); // bounded to 10000 elements
...
define(__m[2/*vs/base/common/winjs.base*/], __M([33/*vs/base/common/winjs.base.raw*/]), function (winjs) {
	'use strict';
	return {
...
define(__m[8/*vs/base/common/errors*/], __M([1/*require*/,0/*exports*/,4/*vs/base/common/platform*/,17/*vs/base/common/types*/,2/*vs/base/common/winjs.base*/]), function (require, exports, platform, types, winjs_base_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
...
define(__m[16/*vs/base/common/callbackList*/], __M([1/*require*/,0/*exports*/,8/*vs/base/common/errors*/,25/*vs/base/common/linkedList*/]), function (require, exports, errors_1, linkedList_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
    ...
    var CallbackList = /** @class */ (function () {
        ...
        CallbackList.prototype.invoke = function () {
            ...
            for (var _a = 0, elements_1 = elements; _a < elements_1.length; _a++) {
                var _b = elements_1[_a], callback = _b[0], context_1 = _b[1];
                try {
                    ret.push(callback.apply(context_1, args));
                }
                catch (e) {
...
define(__m[7/*vs/base/common/event*/], __M([1/*require*/,0/*exports*/,9/*vs/base/common/lifecycle*/,16/*vs/base/common/callbackList*/,2/*vs/base/common/winjs.base*/,12/*vs/base/common/functional*/]), function (require, exports, lifecycle_1, callbackList_1, winjs_base_1, functional_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
            ...
            get: function () {
                ...
                if (!this._event) {
                    this._event = function (listener, thisArgs, disposables) {
                        ...
                        var remove = _this._callbacks.add(listener, thisArgs);
    ...
    var Relay = /** @class */ (function () {
        function Relay() {
            this.emitter = new Emitter();
            this.output = this.emitter.event;
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[11/*vs/base/common/cancellation*/], __M([1/*require*/,0/*exports*/,7/*vs/base/common/event*/]), function (require, exports, event_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[19/*vs/base/common/async*/], __M([1/*require*/,0/*exports*/,8/*vs/base/common/errors*/,4/*vs/base/common/platform*/,2/*vs/base/common/winjs.base*/,11/*vs/base/common/cancellation*/,9/*vs/base/common/lifecycle*/,7/*vs/base/common/event*/]), function (require, exports, errors, platform, winjs_base_1, cancellation_1, lifecycle_1, event_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
     ...
     */
    var PeriodThrottledDelayer = /** @class */ (function (_super) {
...
define(__m[32/*vs/base/common/worker/simpleWorker*/], __M([1/*require*/,0/*exports*/,8/*vs/base/common/errors*/,9/*vs/base/common/lifecycle*/,2/*vs/base/common/winjs.base*/,19/*vs/base/common/async*/,4/*vs/base/common/platform*/]), function (require, exports, errors_1, lifecycle_1, winjs_base_1, async_1, platform_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
...
define(__m[23/*vs/editor/common/core/selection*/], __M([1/*require*/,0/*exports*/,5/*vs/editor/common/core/range*/,3/*vs/editor/common/core/position*/]), function (require, exports, range_1, position_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
...
define(__m[10/*vs/editor/common/core/uint*/], __M([1/*require*/,0/*exports*/]), function (require, exports) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
...
define(__m[26/*vs/editor/common/core/characterClassifier*/], __M([1/*require*/,0/*exports*/,10/*vs/editor/common/core/uint*/]), function (require, exports, uint_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
...
define(__m[27/*vs/editor/common/diff/diffComputer*/], __M([1/*require*/,0/*exports*/,13/*vs/base/common/diff/diff*/,22/*vs/base/common/strings*/]), function (require, exports, diff_1, strings) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
...
define(__m[28/*vs/editor/common/model/wordHelper*/], __M([1/*require*/,0/*exports*/]), function (require, exports) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
...
define(__m[29/*vs/editor/common/modes/linkComputer*/], __M([1/*require*/,0/*exports*/,26/*vs/editor/common/core/characterClassifier*/,10/*vs/editor/common/core/uint*/]), function (require, exports, characterClassifier_1, uint_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
...
define(__m[30/*vs/editor/common/modes/supports/inplaceReplaceSupport*/], __M([1/*require*/,0/*exports*/]), function (require, exports) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
...
define(__m[31/*vs/editor/common/standalone/standaloneBase*/], __M([1/*require*/,0/*exports*/,7/*vs/base/common/event*/,15/*vs/base/common/keyCodes*/,3/*vs/editor/common/core/position*/,5/*vs/editor/common/core/range*/,23/*vs/editor/common/core/selection*/,2/*vs/base/common/winjs.base*/,11/*vs/base/common/cancellation*/,24/*vs/editor/common/core/token*/,6/*vs/base/common/uri*/]), function (require, exports, event_1, keyCodes_1, position_1, range_1, selection_1, winjs_base_1, cancellation_1, token_1, uri_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
...
define(__m[20/*vs/editor/common/viewModel/prefixSumComputer*/], __M([1/*require*/,0/*exports*/,10/*vs/editor/common/core/uint*/]), function (require, exports, uint_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
...
define(__m[14/*vs/editor/common/model/mirrorModel*/], __M([1/*require*/,0/*exports*/,20/*vs/editor/common/viewModel/prefixSumComputer*/]), function (require, exports, prefixSumComputer_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the MIT License. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
    var MirrorModel = /** @class */ (function () {
...
define(__m[34/*vs/editor/common/services/editorSimpleWorker*/], __M([1/*require*/,0/*exports*/,6/*vs/base/common/uri*/,2/*vs/base/common/winjs.base*/,5/*vs/editor/common/core/range*/,27/*vs/editor/common/diff/diffComputer*/,13/*vs/base/common/diff/diff*/,3/*vs/editor/common/core/position*/,14/*vs/editor/common/model/mirrorModel*/,29/*vs/editor/common/modes/linkComputer*/,30/*vs/editor/common/modes/supports/inplaceReplaceSupport*/,28/*vs/editor/common/model/wordHelper*/,31/*vs/editor/common/standalone/standaloneBase*/]), function (require, exports, uri_1, winjs_base_1, range_1, diffComputer_1, diff_1, position_1, mirrorModel_1, linkComputer_1, inplaceReplaceSupport_1, wordHelper_1, standaloneBase_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * @internal
